...
import { CustomerAuthenticatedRequest, CustomerAuthenticatedUser } from '../authenticated-request';
...
export class AccessTokenGuard implements CanActivate {
  ...
  private toUser(payload: AccessTokenPayload): CustomerAuthenticatedUser {
